...
module type Bitvector_Backward = sig
  ...
  (* nsw means no signed overflow, nuw means no unwrapped overflow. No
     ...
     precision. *)
  val biadd: size:int -> nsw:bool -> nuw:bool -> (bitvector,bitvector,bitvector) Arity.ar2
  val bisub: size:int -> nsw:bool -> nuw:bool -> (bitvector,bitvector,bitvector) Arity.ar2    
