...
(*                                                                        *)
(**************************************************************************)
(* A concrete interpreter for the transfer functions. 
   Also used to precisely define their semantics. *)

module Forward_Interpreter_Arity = struct
  type 'r ar0 = 'r
  type ('a,'r) ar1 = 'a -> 'r
...
module Boolean_Interp:Transfer_functions_sig.Boolean_Forward
  with module Arity := Forward_Interpreter_Arity
