...
\hypersetup{
    pdfauthor   = {Gilles Mouchard, Réda Nouacer},%
    pdftitle    = {Fast Simulation Techniques State of the Art},%
    pdfsubject  = {UNISIM},%
...
\title{Fast Simulation Techniques\\State of the Art}
\author{Gilles Mouchard, Réda Nouacer}
\date{}
...
\newpage
\input{fast_sim_sota/fast_sim_sota}
...
\bibliography{fast_sim_sota/fast_sim_sota}
