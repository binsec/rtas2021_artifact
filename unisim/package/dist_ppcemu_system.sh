#!/bin/bash
SIMPKG=ppcemu-system
SIMPKG_SRCDIR=tlm/ppcemu_system
SIMPKG_DSTDIR=ppcemu_system
...
import unisim/component/tlm/pci/ide || exit
import unisim/component/tlm/pci/macio || exit
import unisim/component/cxx/pci || exit
import unisim/service/sdl || exit
import unisim/component/tlm/bridge/pci_isa || exit
import unisim/component/tlm/isa/i8042 || exit
...
AC_INIT([UNISIM PowerMAC G4 PCI Standalone simulator], [${SIMULATOR_VERSION}], [Gilles Mouchard <gilles.mouchard@cea.fr>, Daniel Gracia Perez <daniel.gracia-perez@cea.fr>, Reda Nouacer <reda.nouacer@cea.fr>], [unisim-${SIMPKG}])
...
AC_INIT([UNISIM PowerMac G4 PCI C++ simulator], [${SIMULATOR_VERSION}], [Gilles Mouchard <gilles.mouchard@cea.fr>, Daniel Gracia Perez <daniel.gracia-perez@cea.fr>, Reda Nouacer <reda.nouacer@cea.fr>], [unisim-${SIMPKG}-core])
